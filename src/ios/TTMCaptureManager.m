...
<AVCaptureFileOutputRecordingDelegate, AVCaptureAudioDataOutputSampleBufferDelegate, AVCaptureVideoDataOutputSampleBufferDelegate>
{
    ...
    int screenShotDispatchCount;
    NSDate* previousScreenTime;
    NSLock* imagesQueueLock;
    NSDate* startTime;
    NSMutableArray* screenShotsCache;
}
...

{
    ...
    if (self) {
        ...
        screenShotDispatchCount=0;
        self.screenShotCount=0;
        previousScreenTime=[NSDate date];
        ...
        if (previewView) {
            ...
            [[self.previewLayer connection] setAutomaticallyAdjustsVideoMirroring:NO];
...
- (void)startRecordingInDirectory:(NSString*)directoryPath AndFilePrefix:(NSString*)prefix{
    ...
    NSString *documentsDirectory =directoryPath; //[paths objectAtIndex:0];
